...
A sample newsletter generated by the workflow is available here:

[View Sample Newsletter](sample/sample-newsletter.html)

The newsletter contains the selected stories along with their importance score, source, publication date, summary, and link to the original article.
